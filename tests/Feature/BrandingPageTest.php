...
class BrandingPageTest extends TestCase
{
    ...
    public function test_home_includes_platform_icon_classes(): void
    {
        $this->get('/')
            ...
            ->assertSee('Encrypted end to end', false)
            ->assertSee('No central servers', false)
            ->assertSee('No signup', false)
            ->assertSee('Radio, mesh, or internet', false)
            ->assertSee('Kept on your device', false)
    ...
    public function test_git_page_lists_mirrors(): void
    {
        $this->get('/git')
            ...
            ->assertSee('/vendor/reticulum-logo.webp', false)
    ...
    public function test_home_uses_reticulum_logo_as_hero_background(): void
    {
        $this->get('/')
            ->assertOk()
            ->assertSee('src="/vendor/reticulum-logo.webp"', false)
