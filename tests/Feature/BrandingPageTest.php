...
class BrandingPageTest extends TestCase
{
    ...
    public function test_home_includes_platform_icon_classes(): void
    {
        $this->get('/')
            ->assertOk()
            ->assertSee('mdi-apple', false)
            ->assertSee('mdi-linux', false)
            ->assertSee('mdi-microsoft-windows', false)
            ->assertSee('mdi-docker', false)
            ->assertSee('mdi-language-python', false)
            ->assertSee('mdi-android', false)
